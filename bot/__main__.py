...
if START_IMG is None:
    img = "https://telegra.ph/file/4d133fe4053afe2649110.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="⚙️Help",callback_data="help_back"),InlineKeyboardButton(text="❤️Owner❤️",url="https://t.me/Kaveesha_Induwara"),InlineKeyboardButton(text="🀄️Group🀄️",url="https://t.me/Tech_Wizard_Ent")]]
    keyboard += [[InlineKeyboardButton(text="♻️Connect Group", callback_data="main_connect"),InlineKeyboardButton(text="Add Me➕",url="t.me/{}?startgroup=true".format(bot.username)),InlineKeyboardButton(text="🃏Channel🃏",url="https://t.me/Tech_Wizard_Entertainment")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚙️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="😴Contact Creator",url="https://t.me/Kaveesha_Induwara")]]))
        return
